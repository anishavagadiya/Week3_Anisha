...
public class Programme_3_MarkSheet {
    public static <string> void main(String[] args) {
        ...
        java.lang.String grade = calculateGrade(percentage, result);
    ...
    public static java.lang.String calculateResult(int mathsMarks, int scienceMarks, int englishMarks) {
    ...
    public static java.lang.String calculateGrade(int percentage, String result){
